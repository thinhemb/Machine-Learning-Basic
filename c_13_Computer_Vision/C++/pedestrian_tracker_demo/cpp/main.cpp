...
int main(int argc, char **argv) {
    try {
        ...
        cv::Size firstFrameSize = frame.size(); // size of frame


        // write video
        cv::VideoWriter videoWriter;
        videoWriter.open("/home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Data/video_output/4.AVI", cv::VideoWriter::fourcc('M', 'J', 'P', 'G'),
        ...
        for (unsigned frameIdx = 0; ; ++frameIdx) 
        {
            ...
            if(frameIdx %2==1 or frameIdx%3==1 or frameIdx%5==0)
            {
                continue;
            }
            max++;
...
//chatgptfree01@gmail.com
//hangtangae
            // detect persion
            pedestrian_detector.waitAndFetchResults();


            // get resutl detect into tracker
            ...
            // }
            std::string name_image="/home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Data/image/image"+std::to_string(max)+".jpg";
            ...
            // std::cout<<"FPS: "<<elapsed_seconds.count()/std::ctime(&end_time)<<std::endl;
        }

        std::cout<<"Number Frame: "<<max<<std::endl;
        auto end = std::chrono::system_clock::now();
...
// ./pedestrian_tracker_demo -i /home/thinhdv/Downloads/1.mp4 -m_det /home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Data/person-detection-retail-0013/FP16-INT8/person-detection-retail-0013.xml -m_reid /home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Data/person-reidentification-retail-0277/FP16-INT8/person-reidentification-retail-0277.xml -d_det GPU

// export LD_LIBRARY_PATH=:LD_LIBRARY_PATH:/home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Libs/ngraph/lib:/home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Libs/inference_engine/lib/intel64
// ./PerTrack -i /home/thinhdv/Downloads/1.mp4 -m_det /home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Data/person-detection-retail-0013/FP16-INT8/person-detection-retail-0013.xml -m_reid /home/thinhdv/WorkSpace/pedestrian_tracker_demo/cpp/Data/person-reidentification-retail-0277/FP16-INT8/person-reidentification-retail-0277.xml 